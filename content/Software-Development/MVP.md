...
1. **Minimum:** It has the absolute smallest set of features required to function. Every extra bell and whistle is deliberately left out.
2. **Viable:** It actually works well enough for users to complete their core task. It shouldn't crash constantly or be unusable. 
3. **Product:** It is a real, released product that real paying or active users can interact with (unlike a wireframe or a mockup).
...
- **Test assumptions quickly:** You assume people will pay for your app. An MVP lets you test that assumption with $10,000 and 3 months of work, rather than $1,000,000 and 2 years of work.
