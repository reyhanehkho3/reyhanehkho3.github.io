...
tags:
  ...
  - springframework
---
In the [Spring Framework](https://docs.spring.io/spring-framework/reference/core/beans/introduction.html), a **bean** is simply a Java object that is instantiated, configured, and entirely managed by the **Spring Inversion of Control (IoC) container**.
